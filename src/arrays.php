...
$stars = [
  ...
  $organisation = [
    [
      ...
      'class' => 'rueketanous-logo',
    ],
    [
      'link' => 'https://www.maison-environnement.fr/',
      'src' => './assets/logos/maison_de_l\'environnement.webp',
      'alt' => 'logo de l\'association la Maison de l’Environnement',
      'class' => 'maison-env-logo',
    ],
    [
      'link' => 'https://www.greenpeace.fr/',
      'src' => './assets/logos/Greenpeace_logo.webp',
      'alt' => 'logo de l\'association Greenpeace',
      'class' => 'greenpeace-logo',
    ],
    [
